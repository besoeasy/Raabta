<template>
  <div class="chat-window h-full flex flex-col bg-gray-50">
    <!-- No Chat Selected -->
    <div v-if="!activeContact" class="flex-1 flex flex-col">
      <!-- Header with hamburger menu for mobile -->
      <div class="bg-white border-b border-gray-200 px-3 md:px-4 py-3 flex items-center gap-2 md:gap-3 md:hidden">
        <button 
        ...
        <h3 class="font-semibold text-gray-900">Raabta</h3>
      </div>
      ...
      <div class="flex-1 flex items-center justify-center">
        <div class="text-center text-gray-500">
          ...
          <p class="text-sm hidden md:block">Choose a conversation from the sidebar</p>
          <p class="text-sm md:hidden">Tap the menu to view your chats</p>
        </div>
      </div>
    </div>
